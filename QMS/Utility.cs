...
namespace QMS
{
    ...
    public class db_Utility
    {
        ...
        public string strElect = "Data Source=172.16.3.2;Initial Catalog=SAMS;User ID=sa;Password=sqlserver@2018!@#;Persist Security Info=True;TrustServerCertificate=True;";
    ...
    public class ClsUtility
    {
        ...
        public string SendMailViaIIS_htmls(string from, string to, string cc, string bcc, string subject, string _body, string MAIL_PASSWORD, string Host, string attachPath = "")
        {
            ...
            try
            {
                ...
                mail.From = new System.Net.Mail.MailAddress(_from, "GroupL");
