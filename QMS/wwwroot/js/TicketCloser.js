...
function TicketClosureBinddd(ticketno) {
    ...
    $.ajax({
        url: '/TicketGenerator/TicketClosureBind',
        type: 'post',
        data: {
            ticketno: ticketno
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                /* var url = 'data:image/jpeg;base64,' + data[i].ClosurePhoto;*/
                /* var url1 = 'data:image/jpeg;base64,' + data[i].TicketGenerateImage1;*/
                //var url5 = 'data:image/jpeg;base64,' + data[i].TicketGenerateImage2;
                //var url3 = 'data:image/jpeg;base64,' + data[i].ObservationClientSign;
                // var url4 = 'data:image/jpeg;base64,' + data[i].ObservationSign;
                //var url2 = 'data:image/jpeg;base64,' + data[i].ClosureSign;
                //var url6 = 'data:image/jpeg;base64,' + data[i].CreationSign;
...
function addtoquotationrevieweddd(tickitnoid) {
    ...
    $.ajax({
        url: myurl + '/TicketGenerator/GetDataToReviewdd',
